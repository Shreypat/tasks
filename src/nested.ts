...
export function sumPoints(questions: Question[]): number {
    ...
    return firstQuestion.points + sumPoints(remainingQuestions);
}
...
export function sameType(questions: Question[]): boolean {
    ...
    const [firstQuestion, ...restQuestions] = questions;

    return restQuestions.every(
        (question) => question.type === firstQuestion.type
    );
}
...
export function addNewQuestion(
    ...
    return questions.concat(blankQuestion);
}
